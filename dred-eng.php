...
<div class="news-hero position-relative">
    ...
    <div class="feature-content position-absolute bg-dark bg-opacity-30 text-white px-4 top-50 translate-middle-y">
        <div class="col-lg-6 col-md-8 col-sm-10">
            <h1 class="display-4 fw-bold text-uppercase">Dredging and Engineering</h1>
            <p class="small">
...
<div class="p-lg-6 welcome p-md-5 p-sm-3">     
            <div class="row g-5">
                ...
                <div class="col-lg-8 col-md-12 col-sm-12">
                    <h3 class="mb-3 text-primary h-sm-5 fw-bold text-uppercase">SMTA Dredging and Engineering</h3>

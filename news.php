    ...
    <div class="row g-2 m-0 py-4">
        ...
        <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-12 col-sm-12">
            ...
            <div class="news-content text-justify">
                ...
                <img src="https://www.royalihc.com/sites/default/files/styles/twig_image_landscape_1844_826/public/images/DSCF0032.webp?itok=A89a_0hm" class="img-fluid m-2 rounded" alt="news-image">
        ...
        <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-12 col-sm-12">
            <div class="catagory-section">
                <h3 class="fw-bold text-center text-white p-3 mt-2 bg-primary">Letest News</h3>

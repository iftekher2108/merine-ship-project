...
<div class="news-hero position-relative">
    <img src="./assets/images/career-banner.jpg" class="img-fluid w-100 h-100" alt="feature-img">

    <div class="feature-content position-absolute bg-dark bg-opacity-30 text-white px-4 top-50 translate-middle-y">
        <h1 class="fw-bold display-3 text-uppercase">Career</h1>
...
<div>
    ...
    <div class="career-reward px-2 py-lg-7 py-md-5 py-4">
        <div class="content text-white col-lg-8 col-md-10 col-sm-12">
            ...
            <p>Do you wonder why one competitor in a "mature" industry thrives while others fail? Do you have huge ambitions about what you and a team of committed people can do to positively change an organization like SMTA? Your voice and ideas are valued regardless of your tenure. SMTA Holdings’ continuous growth demands that we attract the most exceptional people. Applicants from different backgrounds are welcome.</p>
        </div>
    </div>
    <!-- reward -->
    ...
    <!-- 
    <div class="service-read-section row bg-primary mb-5 m-1 position-relative">
        ...
        <div class="block-content col-lg-6 col-md-12 col-sm-12 p-0 m-0 position-absolute bg-primary bg-opacity-50 h-100 top-0 end-0">
    ...
    <div class="service-read-section row bg-primary mb-5 m-1 position-relative">
        ...
        <div class="block-content col-lg-6 col-md-12 col-sm-12 p-0 m-0 position-absolute bg-primary bg-opacity-50 h-100 top-0 start-0">
        ...
        <div class="block-content col-lg-6 col-md-12 col-sm-12 p-0 m-0 position-absolute bg-primary bg-opacity-50 h-100 top-0 start-0">
            ...
            <div class=" p-5 mt-2 text-white">
                <div class="d-flex gap-3 flex-wrap mb-3">
                    ...
                    <h2 class="fw-bold">TRANSPORT <br>
                        LOGISTICS
                    </h2>
                </div>

                <p class="line-clamp-6">
                    SMTA project Operations Managers and professional delivery crews are versed in the finite
                    detail to provide a flawless journey for any cargo, provide marine transportation services
                    to any destination and SMTA offers a full range of services with attention to every
                    requested detail. SMTA 24/7/365 maritime transportation services are backed up by a

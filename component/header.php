        ...
        <div class="fixed-top">
            <div class="container info-content">
                <div class=" d-none d-xxl-flex d-xl-flex d-lg-flex d-md-flex d-sm-none align-items-center justify-content-between mt-5">
                    ...
                    <div class="d-flex fs-6 my-2 gap-2 justify-content-end">
            ...
            <nav class="navbar menu navbar-expand-lg">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.html">
                        <img src="./assets/images/logo.png" width="130" class="img-fluid z-4 p-0 m-0" alt="logo">
                    </a>
                    <button class="navbar-toggler bg-primary me-3 shadow-none" type="button" data-bs-toggle="collapse"
                        ...
                        <ul class="navbar-nav gap-2 ms-auto mb-2 mb-lg-0 me-2">
                                ...
                                <ul class="dropdown-menu animate slideIn" aria-labelledby="dropdownMenuButton">
                                    ...
                                    <li>
                                        ...
                                        <ul class="dropdown-menu dropdown-submenu animate slideIn">
                                            <li>
                                                <a class="dropdown-item" href="#">Submenu item 5 <i
                                                        class="fa-solid small fa-caret-right"></i> </a>
                                                <ul class="dropdown-menu dropdown-submenu animate slideIn">
                                                    <li>
                                            ...
                                            <li>
                                                <a class="dropdown-item" href="#">Submenu item 3 <i
                                                        class="fa-solid small fa-caret-right"></i> </a>
                                                <ul class="dropdown-menu dropdown-submenu animate slideIn">
                                                    <li>
                                                        <a class="dropdown-item" href="#">Multi level 1</a>
                            ...
                            <li>
                                <a href="https://www.bb.org.bd/en/index.php/econdata/exchangerate" target="_blank"
                                    class="nav-link active">Exchange Rate</a>
                            </li>
